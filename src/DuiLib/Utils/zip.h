...
HZIP CreateZip(const TCHAR *fn, const char *password=NULL);
HZIP CreateZip(void *buf,unsigned int len, const char *password=NULL);
HZIP CreateZipHandle(HANDLE h, const char *password=NULL);
