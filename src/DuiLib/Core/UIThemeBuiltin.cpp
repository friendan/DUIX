...
namespace DuiLib {
	...
	void CThemeManager::RegisterBuiltinThemes()
	{
		...
		// info 用青，避免与 primary 同色分不清
		pAzure->SetToken(_T("color-info"), 0x13C2C2FF);
		pAzure->SetToken(_T("color-info-hover"), 0x36CFC9FF);
		pAzure->SetToken(_T("color-info-active"), 0x08979CFF);
		pAzure->SetToken(_T("color-info-text"), 0xFFFFFFFF);
		pAzure->SetToken(_T("color-info-border-hover"), 0x36CFC9FF);
		pAzure->SetToken(_T("color-info-border-active"), 0x08979CFF);
		pAzure->SetToken(_T("color-border"), 0xE6EBF5FF);
		pAzure->SetToken(_T("color-border-strong"), 0xADC2DEFF);
		...
		pAzure->SetToken(_T("color-scrollbar-thumb-hover"), 0x8FA0B5FF);
		...
		// success 略深，与 primary 翠区分开
		pEmerald->SetToken(_T("color-success"), 0x059669FF);
		pEmerald->SetToken(_T("color-success-hover"), 0x047857FF);
		pEmerald->SetToken(_T("color-success-active"), 0x065F46FF);
		pEmerald->SetToken(_T("color-success-border-hover"), 0x047857FF);
		pEmerald->SetToken(_T("color-success-border-active"), 0x065F46FF);
		pEmerald->SetToken(_T("color-border"), 0xE6F0EBFF);
		pEmerald->SetToken(_T("color-border-strong"), 0x9BB5A8FF);
		pEmerald->SetToken(_T("color-control-border"), 0xD9D9D9FF);
