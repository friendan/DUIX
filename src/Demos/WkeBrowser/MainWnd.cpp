...
DUI_BEGIN_MESSAGE_MAP(CMainWnd, WindowImplBase)
	...
	DUI_ON_MSGTYPE(DUI_MSGTYPE_RETURN,CMainWnd::OnReturn)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_SELECTCHANGED,CMainWnd::OnSelectChanged)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_TABINDEXCHANGED,CMainWnd::OnTabIndexChanged)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_TABCLOSED,CMainWnd::OnTabClosed)
DUI_END_MESSAGE_MAP()
