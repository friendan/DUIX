...
DUI_BEGIN_MESSAGE_MAP(CPopWnd, WindowImplBase)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_CLICK,CPopWnd::OnClick)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_ITEMSELECT,CPopWnd::OnItemSelect)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_SELECTCHANGED,CPopWnd::OnSelectChanged)
DUI_END_MESSAGE_MAP()
